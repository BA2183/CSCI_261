...
int main() {
    ...
    LinkedList<int>* listZeroOne = new LinkedList<int>;
    ...
    LinkedList<int>* listZeroTwo = new LinkedList<int>;
    ...
    *listZeroTwo = *listZeroOne;
    ...
    LinkedList<int> (*listZeroThree) = new LinkedList<int>((*listZeroOne));
    ...
    // STRING LinkedList
    // step 1: create
    LinkedList<string>* listZeroFour = new LinkedList<string>;

    // step 2: add string: front "is", back "working", front "This"
    (*listZeroFour).pushFront("is");
    (*listZeroFour).pushBack("working");
    (*listZeroFour).pushFront("This");
    (*listZeroFour).pushBack("now.");

    // step 3: print content
    cout << "\nLIST 04 TEST\nlist 04 content: ";
    for (int a = 0; a < (*listZeroFour).size(); a++) {
        cout << (*listZeroFour).at(a) << " ";
    }
    cout << "\n";

    // step 4: delete
    cout << "deleting list 04 . . . ";
    delete listZeroFour;
    cout << "delete sucess!";
